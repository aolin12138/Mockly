...
Source: http://localhost:5175/results/1
...
| `extracted/tokens.json` | Design tokens: 20 colors, 0 fonts, 9 headings, 0 CTAs |
...
- **Colors**: #E2E8F0 (bg-light), #747474 (neutral), #0F172B (accent), #020618 (bg-dark), #F5FFFF (bg-light), #0F162A (accent), #0A0A0A (bg-dark), #F1F5F9 (bg-light), #45556C (neutral), #00BA76 (accent)
- **Fonts**: none detected
