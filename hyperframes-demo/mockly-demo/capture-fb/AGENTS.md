...
Source: http://localhost:5173/results/1
...
| `extracted/tokens.json` | Design tokens: 20 colors, 0 fonts, 1 headings, 1 CTAs |
...
- **Colors**: #020618 (bg-dark), #FAFAFA (bg-light), #FFFFFF (bg-light), #0A0A0A (bg-dark), #F5FFFF (bg-light), #747474 (neutral), #90A1B9 (neutral), #171717 (surface-dark), #262626 (surface-dark), #00D492 (accent)
- **Fonts**: none detected
