...
export default {
  ...
  frames: [
    ...
    },
    {
      ...
      type: 'typewrite',
      target: 'problem_body',
      text: 'Given an array of integers and a target, return indices of the two numbers that add to the target. You may assume exactly one solution and you cannot use the same element twice.',
    },
