...
export const Waveform = ({
  ...
  const handleClick = (e) => {
    ...
    const barIndex = Math.floor(x / step);
    const totalBars = Math.floor(rect.width / step);
    const dataIndex = Math.floor((barIndex * data.length) / totalBars);
...
export const StaticWaveform = ({ bars = 40, seed = 42, ...props }) => {
  const data = useMemo(() => {
