  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full flex items-center justify-between gap-3 px-4 py-3 text-left hover:bg-slate-100 transition-colors cursor-pointer"
      >
        <div className="flex-1 min-w-0">
          <p className="text-base text-slate-900 truncate">{claim.cv_claim}</p>
        </div>
      ...
      >
        <div className="px-4 pb-4 pt-1 space-y-3 border-t border-slate-200 bg-white">
          ...
          {claim.what_you_showed && (
            <div>
              <p className="text-xs text-slate-500 font-semibold mb-1">Interview evidence</p>
              <p className="text-sm text-slate-700 leading-relaxed">{claim.what_you_showed}</p>
            </div>
          )}
          ...
          {claim.gap && (
            <div>
              <p className="text-xs text-slate-500 font-semibold mb-1">Gap</p>
              <p className="text-sm text-slate-700 leading-relaxed">{claim.gap}</p>
            </div>
          )}
              ...
              {claim.coaching.how_to_answer && (
                <div className="flex items-start gap-2 bg-emerald-50 border border-emerald-200 rounded-lg p-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 leading-relaxed">{claim.coaching.how_to_answer}</p>
                  </div>
                </div>
              )}
              {claim.coaching.cv_suggestion && (
                <div className="flex items-start gap-2 bg-sky-50 border border-sky-200 rounded-lg p-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 leading-relaxed">{claim.coaching.cv_suggestion}</p>
                  </div>
                </div>
              )}
            </div>
